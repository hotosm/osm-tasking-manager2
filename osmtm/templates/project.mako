...
var highPriorityI18n = "${_('High priority')}";
  ...
  <script src="${request.static_url('osmtm:static/js/lib/d3.v3.js', _query={'v':'2.6.0'})}"></script>
  <script type="text/javascript" src="${request.static_url('osmtm:static/js/project.js', _query={'v':'2.6.0'})}"></script>
  <script type="text/javascript" src="${request.static_url('osmtm:static/js/task.difficulty.js', _query={'v':'2.6.0'})}"></script>
  <script src="${request.static_url('osmtm:static/js/lib/At.js/js/jquery.caret.js', _query={'v':'2.6.0'})}"></script>
  <script src="${request.static_url('osmtm:static/js/lib/At.js/js/jquery.atwho.js', _query={'v':'2.6.0'})}"></script>
</%block>
